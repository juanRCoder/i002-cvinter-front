...
const ContactUs: React.FC = () => {
  return (
    <div id='contact' className="hidden md:block md:max-w-7xl md:m-auto bg-zinc-50 md:my-0 lg:my-6 font-[sans-serif] pt-8">
      <span className='md:pl-5 font-inter text-5xl font-bold texto'>Cvinter</span>
      <div className="text-center px-6">
        <h2 className="text-3xl font-bold">Contacto</h2>
        <p className="text-base text-gray-500 mt-1">Tienes alguna pregunta? Envíanos un mensaje!</p>
      </div>
      <div className="flex lg:my-10 bg-white rounded-lg">
        <div className="m-2 w-5/12 flex justify-center relative bg-blue-2 rounded-lg h-full max-lg:order-1">
          <div className='md:h-[30rem] lg:h-[35rem]'>
            <img
