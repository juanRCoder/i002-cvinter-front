...
const ContactUs: React.FC = () => {
    return (
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif] pt-8">
            <div className="text-center px-6">
                <h2 className="text-gray-800 text-3xl font-extrabold">Contactanos</h2>
                <p className="text-sm text-gray-500 mt-4">Tienes alguna pregunta? Envianos un mensaje!</p>
            </div>

            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">

                <div className="bg-[#6882B4] rounded-lg p-6 h-full max-lg:order-1" style={{ backgroundImage: 'url(./src/assets/phone1.png)', backgroundSize: 'cover' }}>
                    <h2 className="text-xl text-white">Contacto</h2>
                    <p className="text-sm text-gray-300 mt-4">Hablemos!</p>
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-[#6882B4] hover:bg-[#94B9FF]">
