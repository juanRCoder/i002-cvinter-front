...
const Features: React.FC = () => {
  return (
    <div className="absolute top-[73%] left-1/2 transform -translate-x-1/2 flex justify-around bg-green-200 py-4 rounded-full my-4 shadow-lg w-11/12 md:w-2/3 z-10">
